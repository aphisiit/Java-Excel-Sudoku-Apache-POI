...
//        print(mBoxSubset);
    ...
    public boolean solve(int i, int j) {
        ...
        //check if mBoard[i][j] not equal 0;
        if(mBoard[i][j] != 0) {
            return solve(i + 1, j);
        }

        for(int value = 1; value <= mBoardSize; value++) {
            //if value is not equal 0
    ...
    public int[][] getSududo(){
        return mBoard;
    }

    public void printSudooku() {
...
//                    System.out.print("| ");
//                }
//                System.out.print(mBoard[i][j] != 0 ? ((Object) (Boolean.valueOf(table[i][j]))) : " ");
//                System.out.print(' ');
//            }
//
//            System.out.println("|");
